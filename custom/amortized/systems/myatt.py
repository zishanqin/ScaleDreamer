...
class MyATTSystem(BaseLift3DSystem):
    ...
    class Config(BaseLift3DSystem.Config):
        ...
        # renderering related
        rgb_as_latents: bool = False # TODO: do we need to use latents?

        # initialization related
        initialize_shape: bool = True # TODO: check original initialization

        # if the guidance requires training
        train_guidance: bool = False # TODO: check
